...
// To use async, must decorate main function with tokio::main
// It is a macro that created a multi-threaded runtime and wraps the body of the main function
#[tokio::main]
async fn main() -> Result<(), anyhow::Error> {
    ...
    // subdomains is the list of jobs to process
    // It is transformed into Futures holding port scanning tasks.
    // Those Futures are concurrently executed thanks to "buffer_unordered"
    // Stream finally converted back into a Vec with .collect().await
