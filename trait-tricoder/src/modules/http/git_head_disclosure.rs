...
// HTTP module for Git file disclosure vulnerabilities
// Exploit lies in leaving git file publicly available such as .git/config or .git/HEAD
//      ***Sometimes allows an adversary to download all the git history with a script
//              Could give access to credentials and sensitive information.
...
mod tests {
    ...
    fn is_git_head_file() {
        ...
        let body3 = "test test test test  <tle>Index of google.com</title> test";
