...
// HTTP Module for directory listing vulnerabilities
// Misconfigurations allowing for any individual to access files on servers.
...
mod tests {
    ...
    async fn is_directory_listing() {
        ...
        let body = String::from("Content <title>Index of google.ca</title> test");
        let body2 = String::from(">ccece> Contrnt <tle>Index of google.ca</title> test");
