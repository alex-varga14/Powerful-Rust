...
// HTTP module for .DS_Store file vulnerabilities
// Could leak backup files, software architecture information, ...
...
// Write tests in regards to specifications - in this case, .DS_Store specifications
#[cfg(test)]
mod tests {
    #[test]
    fn is_ds_store() {
