...
// For this problem, two modules emerge:
// 1 to enumerate subdomains
// 1 to scan each port
// They will share common features therefore we declare a parent 'Module' trait
pub trait Module {
    fn name(&self) -> String;
...
// Goal of subdomain Module - find all subdomains for a given domain and source.
#[async_trait]
...
// Goal for HTTP Module - given an endpoint of the form 'host:port', check if a vulnerability exists.
#[async_trait]
